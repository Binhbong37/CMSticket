...
import styles from '../../assets/css/pages/ProfilePage.module.css'
        ...
        uploadTask.on(
          ...
          () => {
            getDownloadURL(uploadTask.snapshot.ref).then((downloadURL) => {
              const userRef = doc(db, 'users', (profile as any).id)
              const upload = async () => {
                await updateDoc(userRef, {
                  avatar: downloadURL
                })
                setProfileToLS({ ...profile, avatar: downloadURL } as any)
              }
              upload()
            })
          }
